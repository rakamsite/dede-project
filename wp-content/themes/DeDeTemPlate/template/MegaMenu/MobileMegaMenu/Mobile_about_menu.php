<div id="mobile_about_menu" aria-hidden="false"
    ...
    <div class="flex flex-row items-center text-[#525252] relative">
        <button class="flex gap-2 w-full" type="button" data-drawer-hide="mobile_about_menu">
        ...
        <button type="button" class="float-left" data-drawer-hide="mobile-menu"
                data-drawer-toggle="mobile_about_menu">
    ...
    <div class="mt-2 divide-y text-[#525252]">
		<?php
		$locations  = get_nav_menu_locations();
		$menu_items = wp_get_nav_menu_items( $locations['about-menu'] );
