<div id="mobile_received_menu" aria-hidden="false"
    ...
    <div class="flex flex-row items-center text-[#525252] relative">
        <button class="flex gap-2 w-full" type="button" data-drawer-hide="mobile_received_menu">
        ...
        <button type="button" class="float-left" data-drawer-hide="mobile-menu"
                data-drawer-toggle="mobile_received_menu">
