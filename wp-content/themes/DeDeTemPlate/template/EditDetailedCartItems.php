<div id="Edit_detailed_cart_item_container" class="fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-white shadow-lg rounded-lg w-full md:w-2/5 md:min-w-[750px] z-[80] h-screen md:h-fit hidden py-10 md:py-0">
